...
const input: any = Object.create({ inherited: "from-proto", undef: undefined });
input.own = 1;

console.log(JSON.stringify({
  inherited: input.inherited,
  bracket: input["inherited"],
  inheritedIn: "inherited" in input,
  undefinedIn: "undef" in input,
  missingIn: "missing" in input,
  ownInherited: Object.prototype.hasOwnProperty.call(input, "inherited"),
  own: input.own,
...
{"inherited":"from-proto","bracket":"from-proto","inheritedIn":true,"undefinedIn":true,"missingIn":false,"ownInherited":false,"own":1,"keys":["own"]}
EOF_EXPECTED
...
echo "PASS: Object.create in operator prototype chain"
