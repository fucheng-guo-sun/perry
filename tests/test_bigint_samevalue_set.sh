...
console.log(JSON.stringify({
  objectIs: Object.is(2n, 2n),
  setHas: new Set([2n]).has(2n),
  setDedupes: new Set([2n, 2n]).size,
  arrayIncludes: [2n].includes(2n),
}));
TS
...
{"objectIs":true,"setHas":true,"setDedupes":1,"arrayIncludes":true}
EOF_EXPECTED
...
echo "PASS: BigInt SameValue and Set lookup"
